function atoms = sort_order_surface(order, array, sort_type)

% USPEX 7.3.1
% sort type = 'descend' or 'ascend', sorts the number in array (linear tournament) according to order in structure number Ind_N
