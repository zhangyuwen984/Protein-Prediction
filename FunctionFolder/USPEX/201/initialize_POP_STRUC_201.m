function initialize_POP_STRUC_201()
...
POP_STRUC(1).POPULATION = struct('COORDINATES', {}, 'INIT_COORD', {}, 'LATTICE', {}, 'INIT_LAT', {}, 'INIT_numIons', {}, 'numIons', {},...
                      'struc_entr', {},'order',{}, 'FINGERPRINT', {}, 'K_POINTS', {},'Step', {}, 'Enthalpies', {}, 'Error',{},'Done',{},...
                    'S_order',{},'ToDo',{},'Parents',{},'howCome',{},'JobID',{},'Folder',{},  'typesAList',{},'chanAList',{},'cell',{},...
...
for goodPop = 1: ORG_STRUC.initialPopSize
    ...
    cell=CellList(ID,:);
    ANS  = Random_Init_201(goodPop, Vacuum, cell);
