...
if prod(cell)>1
   bigcell= cell;
   bigcell(3)=1;
  [bulk_lat, bulk_pos, bulk_atyp, bulk_numIons]=...
   supercell(bulk_lat,bulk_pos,bulk_atyp,bulk_numIons, bigcell);
end
...
for i=1:N_T
    if (ORG_STRUC.numIons(i)==0)
        ...
        atom = ORG_STRUC.numIons(i)*prod(cell);
...
while ~goodBad
    ...
    symope_GB(nsym, sur_numIons, ini_lat, minDistMatrice);
