function Permutation_110(Ind_No)
...
while goodMutant + goodMutLattice ~= 2
    ...
    for i = 1:sum(numMols)
       order(i)= POP_STRUC.POPULATION(Ind_P).MOLECULE(i).order;
    end
    ...
    if goodMutant+ goodMutLattice == 2
        ...
        info_parents(1).parent=POP_STRUC.POPULATION(Ind_P).Number;
        info_parents.noOfSwapsNow=noOfSwapsNow;
        info_parents.enthalpy=POP_STRUC.POPULATION(Ind_P).FITNESSES(end);
