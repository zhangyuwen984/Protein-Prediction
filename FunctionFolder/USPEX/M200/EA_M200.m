...
while POP_STRUC.generation < ORG_STRUC.numGenerations + 0.5
    ...
    if ToStop==1
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        Operation = {'Heredity_M200', 'Random_M200', 'Permutation_M200', 'SoftModeMutation_M200', 'LatticeMutation_M200'};
        Num_Opera = [ORG_STRUC.howManyOffsprings, ORG_STRUC.howManyRand, ORG_STRUC.howManyPermutations, ...
            ORG_STRUC.howManyAtomMutations, ORG_STRUC.howManyMutations];
        count = 0;
