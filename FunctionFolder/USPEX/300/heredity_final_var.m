...
numBlocks1= POP_STRUC.POPULATION(par_one).numIons/ORG_STRUC.numIons;
...
numBlocks2= POP_STRUC.POPULATION(par_two).numIons/ORG_STRUC.numIons;

%for single block, always make the parents have same atoms before the marriage.
