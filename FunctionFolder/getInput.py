...
# encoding: utf-8
'''
getInput -- Get parameters from INPUT.txt file
getInput is a program to get parameters from USPEX's INPUT.txt file. Both
formats are supported ('%Start...%End' and 'Value : Variable')

@author:     Maksim Rakitin
@copyright:  2014 Oganov's Lab. All rights reserved.
@contact:    maksim.rakitin@stonybrook.edu
@deffield    updated: 2014-01-06
'''
